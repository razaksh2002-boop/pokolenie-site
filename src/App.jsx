...
const T = {
  ru: {
    ...
    founder_details:["Международный эксперт в области гуманитарного сотрудничества","Экс заместитель Управляющего делами ДУМ г. Москвы и Центрального региона «Московский муфтият»","Экс руководитель департамента международных отношений Духовного собрания мусульман России","Выпускник программы профессиональной переподготовки Дипломатической академии МИД России","Организатор крупных международных форумов и конференций","Инициатор федеральных инициатив в области спортивной дипломатии","Магистр теологии","Организатор федеральной спортивной лиги «Спорт — путь к единству»","Экс руководитель федерального проекта «Росмигрант — центр правовой защиты и социально-культурной адаптации мигрантов» (45 регионов России)","Эксперт в области гуманитарного сотрудничества с исламским миром"],
    founder_projects:"Ключевые проекты и форумы",forums:["Федеральный проект «Росмигрант»","Международные межрелигиозные форумы","Всероссийские межрелигиозные форумы","Проекты в области спортивной дипломатии","Гуманитарные инициативы с международным участием"],
  ...
  en: {
    ...
    founder_details:["International expert in humanitarian cooperation","Former Deputy Managing Director of the Muslim Spiritual Board of Moscow and the Central Region (Moscow Muftiate)","Former Head of the International Relations Department of the Spiritual Assembly of Muslims of Russia","Graduate of the Diplomatic Academy of the MFA of Russia — professional retraining program","Organiser of major international forums and conferences","Initiator of federal sports diplomacy initiatives","Master of Theology","Organiser of the Federal Sports League «Sport — Path to Unity»","Former Director of the Federal Project «Rosmigrant — Centre for Legal Protection and Socio-Cultural Adaptation of Migrants» (45 regions of Russia)","Expert in humanitarian cooperation with the Islamic world"],
    founder_projects:"Key Projects & Forums",forums:["Federal Project «Rosmigrant»","International Interreligious Forums","All-Russian Interreligious Forums","Sport Diplomacy Initiatives","Humanitarian Initiatives with International Participation"],
    ...
    contact_label:"Contact & Partnership",contact_title:"Become a Partner",contact_subtitle:"Join the POKOLENIE ecosystem. Reach out to explore educational, cultural, sporting or institutional partnerships.",contact_email_label:"Email",contact_phone_label:"Phone",contact_hq_label:"Headquarters",contact_hq:"Headquarters:\nMoscow, Russian Federation\n\nRepresentative Office:\nKazan, Republic of Tatarstan",
...
function Partners({t}){
  const categories=[
    {label:"International Institutions",items:["Organization of Islamic Cooperation (OIC)","Muslim World League (MWL)","League of Arab States (LAS)","General Assembly of Peoples of the World","Secretariat of the SCO"]},
    {label:"Humanitarian Platforms",items:["KazanForum","VolgaForum","Siberia — Territory of Dialogue","Russian Houses Abroad"]},
    {label:"Interreligious Structures",items:["Spiritual Assembly of Muslims of Russia","All-Russian Interreligious Forums","International Interreligious Dialogue","Federal League «Sport — Path to Unity»"]},
    {label:"Diplomatic Partnerships",items:["Diplomatic Academy of MFA Russia","Republic of Tatarstan","Sport Russia","Islamic Universities Network"]},
  ];
  return(
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(260px,1fr))",gap:20}}>
          {categories.map((cat,ci)=>(
            <Reveal key={ci} delay={ci*.1}>
              <div style={{background:NAVY,border:`1px solid rgba(168,131,42,.18)`,borderRadius:8,overflow:"hidden"}}>
                <div style={{padding:"14px 20px",background:`rgba(168,131,42,.09)`,borderBottom:`1px solid rgba(168,131,42,.18)`}}>
                  <div style={{color:GOLD,fontSize:9,letterSpacing:"0.25em",textTransform:"uppercase",fontFamily:"'Cormorant Garamond',serif",fontWeight:500}}>{cat.label}</div>
                </div>
                <div style={{padding:"14px 20px",display:"flex",flexDirection:"column",gap:9}}>
                  {cat.items.map((item,ii)=>(
                    <div key={ii} style={{display:"flex",alignItems:"flex-start",gap:8}}>
                      <div style={{width:3,height:3,minWidth:3,borderRadius:"50%",background:GOLD,marginTop:6}}/>
                      <span style={{fontFamily:"'Playfair Display',serif",fontSize:11,color:WHITE,opacity:.72,lineHeight:1.5}}>{item}</span>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <Wrap>
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(170px,1fr))",gap:32,marginBottom:40}}>
          ...
          <div>
            ...
            <p style={{fontFamily:"'Playfair Display',serif",fontSize:11,color:MUTED,lineHeight:1.88}}>khus-ab@yandex.ru<br/>+7 925 766 4998<br/><span style={{color:GOLD,fontSize:9,letterSpacing:"0.12em",textTransform:"uppercase"}}>Headquarters:</span><br/>Moscow, Russian Federation<br/><span style={{color:GOLD,fontSize:9,letterSpacing:"0.12em",textTransform:"uppercase"}}>Representative Office:</span><br/>Kazan, Republic of Tatarstan</p>
          </div>
          <div>
